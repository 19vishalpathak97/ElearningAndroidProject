...
public class CustomListAdapter1 extends ArrayAdapter<String> {
    ...
    public CustomListAdapter1(Activity context, String[] itemname, String[] itemdes, String[] filetype) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if(filetype[position].equals("pdf")) {
            imageView.setImageResource(R.drawable.pdf);
        }
        else if(filetype[position].equals("mp4"))
        {
            imageView.setImageResource(R.drawable.video);
        }
        else if(filetype[position].equals("docx"))
        {
            imageView.setImageResource(R.drawable.qp);
        }
        else if(filetype[position].equals("ppt")||filetype[position].equals("pptx"))
        {
            imageView.setImageResource(R.drawable.ppt);
        }
        else if(filetype[position].equals("IMG"))
        {
