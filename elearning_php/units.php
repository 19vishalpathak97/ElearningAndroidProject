<?php
   ...
   //echo"Successfully connected";
	...
	$result = mysqli_query($con,"select distinct(unit) from studymaterial where branch='$branch' and year='$year' and course='$course' and sem='$sem' and subject='$subject' and subtype='$subtype'");
