<?php
   ...
   //echo"Successfully connected";
	...
	$result = mysqli_query($con,"select distinct(subtype) from studymaterial where branch='$branch' and year='$year' and course='$course' and sem='$sem' and subject='$subject' ");
